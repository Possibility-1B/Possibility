...
public class AnimationLoader {
	...
	public static void loadAnimations() throws SlickException{
		...
		playerRunningLeft = new SpriteSheet("res/animations/Player/playerRunningLeft.png", 140, 186);
		playerRunningLeftAnimation = new Animation(playerRunningLeft,50);
		
		playerUpsideDownRunningLeft = new SpriteSheet("res/animations/Player/playerUpsideDownRunningLeft.png", 140, 186);
		playerUpsideDownRunningLeftAnimation = new Animation(playerUpsideDownRunningLeft, 50);
		
		playerUpsideDownRunningRight = new SpriteSheet("res/animations/Player/playerUpsideDownRunningRight.png", 140, 186);

...
public class ImageLoader {
	...
	public static void loadImages() throws SlickException {
		...
		imageMap.put("greenLvl1", makeImage("images/levelNumbers/Green/1.png"));
		imageMap.put("greenLvl2", makeImage("images/levelNumbers/Green/2.png"));
		imageMap.put("greenLvl3", makeImage("images/levelNumbers/Green/3.png"));
		imageMap.put("greenLvl4", makeImage("images/levelNumbers/Green/4.png"));
		imageMap.put("greenLvl5", makeImage("images/levelNumbers/Green/5.png"));
		imageMap.put("greenLvl6", makeImage("images/levelNumbers/Green/6.png"));
		imageMap.put("greenLvl7", makeImage("images/levelNumbers/Green/7.png"));
		imageMap.put("greenLvl8", makeImage("images/levelNumbers/Green/8.png"));

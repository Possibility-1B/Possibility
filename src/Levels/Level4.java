...
public class Level4 extends Level{	
	...
	private int keyX = getWidth()/2 - 135;
	private int keyY = getHeight() - 400;
	...
	private float iceX8 = pX8;
	private float iceY8 = pY8;
	
	private float pWidth = 450;
	private float pHeight = 50;
	...
	private void generateWorld(){		
		...
		TileManager.createBorder(getWidth()/2+50, getHeight()/2, getWidth()/2+90, getHeight()/2);
		TileManager.createBorder(getWidth()/2-180, getHeight()/2+30, getWidth()/2-180, getHeight());
		TileManager.createBorder(getWidth()/2-140, getHeight()/2+30, getWidth()/2-140, getHeight());

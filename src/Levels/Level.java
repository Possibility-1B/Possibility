...
public abstract class Level {
	...
	static void wallsAroundMap() {
		...
		TileManager.createBorder(Main.getScreenWidth() * 3 - 100, 0,
				Main.getScreenWidth() * 3 - 100, Main.getScreenHeight());
		TileManager.createTile(0, 100, 100, Main.getScreenHeight(), "white");
		TileManager.createTile(Main.getScreenWidth() * 3 - 100, 100,
				Main.getScreenWidth() * 3 - 100, Main.getScreenHeight(), "white");
	}

	// Walls around whole map/screen
	static void wallsAroundMapx2() {
		// left wall
		TileManager.createBorder(1, 0, 1, Main.getScreenHeight());
		// top
		...
		TileManager.createBorder(100, 0, 100, Main.getScreenHeight());
		TileManager.createBorder(Main.getScreenWidth() * 2 - 100, 0,
				Main.getScreenWidth() * 2 - 100, Main.getScreenHeight());
		TileManager.createTile(0, 100, 100, Main.getScreenHeight(), "white");
		TileManager.createTile(Main.getScreenWidth() * 2 - 100, 100,
				Main.getScreenWidth() * 2 - 100, Main.getScreenHeight(), "white");
	}

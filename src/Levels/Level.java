...
public abstract class Level 
{
	...
	public static void wallsAroundMap()
	{
		//Walls around whole map/screen
				...
				//right wall
				TileManager.createBorder(Main.getScreenWidth()*3, 0, Main.getScreenWidth()*3, Main.getScreenHeight());
				//bottom
				TileManager.createBorder(1, Main.getScreenHeight()-1 , Main.getScreenWidth()*3 , Main.getScreenHeight()-1);
				...
				TileManager.createBorder(Main.getScreenWidth()*3-100, 0, Main.getScreenWidth()*3-100, Main.getScreenHeight());
				TileManager.createTile(0, 100, 100,Main.getScreenHeight(), "white");
				TileManager.createTile(Main.getScreenWidth()*3-100, 100, Main.getScreenWidth()*3-100,Main.getScreenHeight(), "white");
	}
	...
	public static void wallsAroundMapx2()
	{
		...
		//right wall
		TileManager.createBorder(Main.getScreenWidth()*2, 0, Main.getScreenWidth()*2, Main.getScreenHeight());
		//bottom
		TileManager.createBorder(1, Main.getScreenHeight()-1 , Main.getScreenWidth()*2 , Main.getScreenHeight()-1);
		...
		TileManager.createBorder(100, 0, 100,Main.getScreenHeight());
		TileManager.createBorder(Main.getScreenWidth()*2-100, 0, Main.getScreenWidth()*2-100, Main.getScreenHeight());
		TileManager.createTile(0, 100, 100,Main.getScreenHeight(), "white");
		TileManager.createTile(Main.getScreenWidth()*2-100, 100, Main.getScreenWidth()*2-100,Main.getScreenHeight(), "white");
	}
	...
	public void pushBlockWalls()
	{
		...
		{
			//left
			Border.addBorders(new Line(pB.getBoxShape().getMinX(), pB.getBoxShape().getMinY() + 2, pB.getBoxShape().getMinX(), pB.getBoxShape().getMaxY() - 2));
			//right
			Border.addBorders(new Line(pB.getBoxShape().getMaxX(), pB.getBoxShape().getMinY() + 2, pB.getBoxShape().getMaxX(), pB.getBoxShape().getMaxY() - 2));
			//top
			Border.addBorders(new Line(pB.getBoxShape().getMinX(), pB.getBoxShape().getMinY(), pB.getBoxShape().getMaxX(), pB.getBoxShape().getMinY()));
			//bottom
			Border.addBorders(new Line(pB.getBoxShape().getMinX(), pB.getBoxShape().getMaxY(), pB.getBoxShape().getMaxX(), pB.getBoxShape().getMaxY()));

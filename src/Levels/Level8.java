...
public class Level8 extends Level {
	...
	public void render(Graphics g) throws SlickException {
		...
		if (!keyGrabbed) {
			AnimationLoader.returnAnimation("key").draw(3800, Main.getScreenHeight() - 794, 180,
					180);
		}

		if (keyGrabbed) {
			if (doorTimer < 25) {
				AnimationLoader.returnAnimation("door").draw(3680, Main.getScreenHeight() - 330,
						150, 230);
			}

			if (doorTimer >= 25) {
				ImageLoader.returnImages("openDoor").draw(3680, Main.getScreenHeight() - 330, 150,
						230);
			}
		} else {
	...
	private void generateWorld() {
		...
		TileManager.createBorder(3800, Main.getScreenHeight() - 710, 3925,
				Main.getScreenHeight() - 710);
		TileManager.createBorder(3800, Main.getScreenHeight() - 210, 3925,
				Main.getScreenHeight() - 210);
		TileManager.createBorder(3800, Main.getScreenHeight() - 708, 3800,
				Main.getScreenHeight() - 210);
		TileManager.createBorder(3925, Main.getScreenHeight() - 708, 3925,
				Main.getScreenHeight() - 210);
		TileManager.createBorder(3600, Main.getScreenHeight() - 710, 3725,
				Main.getScreenHeight() - 710);
		TileManager.createBorder(3600, Main.getScreenHeight() - 210, 3725,
				Main.getScreenHeight() - 210);
		TileManager.createBorder(3600, Main.getScreenHeight() - 210, 3600,
				Main.getScreenHeight() - 708);
		TileManager.createBorder(3725, Main.getScreenHeight() - 210, 3725,
				Main.getScreenHeight() - 708);
	...
	public static void setCompleted(boolean isCompleted8) {
		Level8.isCompleted = isCompleted8;
	}

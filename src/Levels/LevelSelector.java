...
public class LevelSelector extends Level {
	...
	public void render(Graphics g) throws SlickException {
		...
		if (Level1.getCompleted()) {
			ImageLoader.returnImages("greenLvl1").draw(lvl1.getCenterX() - 12, getHeight() / 2 - 50 - 80, 22, 102);
		} else {
			ImageLoader.returnImages("lvl1").draw(lvl1.getCenterX() - 12, getHeight() / 2 - 50 - 80, 22, 102);
		}
		if (Level2.getCompleted()) {
			ImageLoader.returnImages("greenLvl2").draw(lvl2.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 100);
		} else {
			ImageLoader.returnImages("lvl2").draw(lvl2.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 100);
		}
		if (Level3.getCompleted()) {
			ImageLoader.returnImages("greenLvl3").draw(lvl3.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 100);
		} else {
			ImageLoader.returnImages("lvl3").draw(lvl3.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 100);
		}
		if (Level4.getCompleted()) {
			ImageLoader.returnImages("greenLvl4").draw(lvl4.getCenterX() - 12, getHeight() / 2 - 50 - 80, 31, 100);
		} else {
			ImageLoader.returnImages("lvl4").draw(lvl4.getCenterX() - 12, getHeight() / 2 - 50 - 80, 31, 100);
		}
		if (Level5.getCompleted()) {
			ImageLoader.returnImages("greenLvl5").draw(lvl5.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 100);
		} else {
			ImageLoader.returnImages("lvl5").draw(lvl5.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 100);
		}
		if (Level6.getCompleted()) {
			ImageLoader.returnImages("greenLvl6").draw(lvl6.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 102);
		} else {
			ImageLoader.returnImages("lvl6").draw(lvl6.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28, 102);
		}
		if (Level7.getCompleted()) {
			ImageLoader.returnImages("greenLvl7").draw(lvl7.getCenterX() - 12, getHeight() / 2 - 50 - 80, 27, 99);
		} else {
			ImageLoader.returnImages("lvl7").draw(lvl7.getCenterX() - 12, getHeight() / 2 - 50 - 80, 27, 99);
		}
		if (Level8.getCompleted()) {
			ImageLoader.returnImages("greenLvl8").draw(lvl8.getCenterX() - 12, getHeight() / 2 - 50 - 80, 27, 101);
		} else {
	...
	private void generateWorld() {
		...
		TileManager.createBorder(getWidth() - (Main.getScreenWidth() / 4), 0, getWidth() - (Main.getScreenWidth() / 4),
				getHeight());

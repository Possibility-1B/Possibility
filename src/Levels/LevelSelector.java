...
public class LevelSelector extends Level {
	...
	public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException {
		...
		if (Game.getP().getyPos() > ((getHeight() / 2) + 200)
				|| Game.getP().getyPos() < ((getHeight() / 2) - 200)) {
	...
	public void render(Graphics g) throws SlickException {
		...
		ImageLoader.returnImages("lvl1").draw(lvl1.getCenterX() - 12, getHeight() / 2 - 50 - 80, 22,
				102);
		ImageLoader.returnImages("lvl2").draw(lvl2.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28,
				100);
		ImageLoader.returnImages("lvl3").draw(lvl3.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28,
				100);
		ImageLoader.returnImages("lvl4").draw(lvl4.getCenterX() - 12, getHeight() / 2 - 50 - 80, 31,
				100);
		ImageLoader.returnImages("lvl5").draw(lvl5.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28,
				100);
		ImageLoader.returnImages("lvl6").draw(lvl6.getCenterX() - 12, getHeight() / 2 - 50 - 80, 28,
				102);
		ImageLoader.returnImages("lvl7").draw(lvl7.getCenterX() - 12, getHeight() / 2 - 50 - 80, 27,
				99);
		ImageLoader.returnImages("lvl8").draw(lvl8.getCenterX() - 12, getHeight() / 2 - 50 - 80, 27,
				101);
		ImageLoader.returnImages("lvlCredits").draw(credits.getCenterX() - 100,
				getHeight() / 2 - 105);

		ImageLoader.returnImages("glow").draw(-75, -75, getWidth() + 175,
				(getHeight() / 2) - 200 + 120);
		ImageLoader.returnImages("glow").draw(-300, -75, 600, Main.getScreenHeight() + 50);
		ImageLoader.returnImages("glow").draw(-75, 675, getWidth() + 175,
				Main.getScreenHeight() + 50);
		ImageLoader.returnImages("glow").draw(-75, 675, getWidth() + 175,
				Main.getScreenHeight() + 50);
		ImageLoader.returnImages("glow").draw(Main.getScreenWidth() + 1320, 0, getWidth() + 175,
				Main.getScreenHeight() + 50);
		ImageLoader.returnImages("glow").draw(Main.getScreenWidth() + 1320, 0, getWidth() + 175,
				Main.getScreenHeight() + 50);
	...
	private void generateWorld() {
		...
		// bottom
		TileManager.createTile(0, (getHeight() / 2) + 200, getWidth(), (getHeight() / 2) + 200,
				"white");
		TileManager.createBorder(0, (getHeight() / 2) + 200, getWidth(), (getHeight() / 2) + 200);
		// left
		TileManager.createTile(0, 0, (Main.getScreenWidth() / 8), getHeight(), "white");
		TileManager.createBorder((Main.getScreenWidth() / 8), 0, (Main.getScreenWidth() / 8),
				getHeight());
		// right
		TileManager.createTile(getWidth() - (Main.getScreenWidth() / 4), 0, getWidth(), getHeight(),
				"white");
		TileManager.createBorder(getWidth() - (Main.getScreenWidth() / 4), 0,
				getWidth() - (Main.getScreenWidth() / 4), getHeight());
	...
	private void renderPortals() throws SlickException {
		if (Game.getP().getPlayerShape().intersects(lvl1)) {
			Level1.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl1.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(lvl2)) {
			Level2.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl2.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(lvl3)) {
			Level3.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl3.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(lvl4)) {
			Level4.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl4.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(lvl5)) {
			Level5.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl5.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(lvl6)) {
			Level6.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl6.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(lvl7)) {
			Level7.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl7.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(lvl8)) {
			Level8.reset();
			AnimationLoader.returnAnimation("openedPortal").draw(lvl8.getX(), getHeight() / 2, 150,
					200);
		...
		if (Game.getP().getPlayerShape().intersects(credits)) {
			AnimationLoader.returnAnimation("openedPortal").draw(credits.getX(), getHeight() / 2,
					150, 200);
			ImageLoader.returnImages("E").draw(credits.getX() + 44, lvl1.getY() - 60, 60, 72);
		} else {
			AnimationLoader.returnAnimation("credits").draw(credits.getX(), getHeight() / 2, 150,
					200);
		}
	}
